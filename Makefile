...
PLANET_TAG := 5.5.48-$(K8S_VER_SUFFIX)
PLANET_BRANCH := $(PLANET_TAG)
K8S_APP_TAG := $(GRAVITY_TAG)
TELEKUBE_APP_TAG := $(GRAVITY_TAG)
WORMHOLE_APP_TAG := $(GRAVITY_TAG)
LOGGING_APP_TAG ?= 5.0.2-1-ga1e90c7
LOGGING_APP_BRANCH := sergei/priority_class
MONITORING_APP_TAG ?= 5.5.16-1-gd702f3e0
MONITORING_APP_BRANCH := sergei/priority_class
DNS_APP_TAG = 0.3.0
BANDWAGON_TAG ?= 5.3.0
